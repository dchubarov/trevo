...
public abstract class HttpRequestProcessor extends LineRequestProcessor {
     ...
     */
    protected abstract HttpStatus processHttpRequest(NetworkServer server, Map<String, String> requestHeaders,
            String requestBody, Map<String, String> responseHeaders, String[] responseBody);

    @Override
    protected final void processRequest(NetworkServer server, BufferedReader requestReader,
